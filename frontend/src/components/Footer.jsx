		...
		<div className="w-full min-h-32  shadow-gray-950 shadow-inner flex flex-col justify-between items-start px-4 py-8 bg-slate-800 text-white">
			...
			<div className="flex items-center justify-start w-full p-4 flex-wrap">
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>Meet sheth</span>
					<span>ahemdabad gujarat</span>
					<span>Pincode - 3600001</span>
					<span>
						<Link
						...
						>
							contact.meetsheth698@gmail.com
						</Link>
					</span>
				</div>
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
				...
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://www.linkedin.com/in/meet-sheth-22637428a/"
							target="_blank"
							rel="noreferrer"
						>
							LinkedIn
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://github.com/meetsheth07"
							target="_blank"
							rel="noreferrer"
						>
							Github
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="mailto:contact.meetsheth698@gmail.com"
							target="_blank"
							rel="noreferrer"
						>
							E-Mail
			...
			<h1 className="font-bold">
				All rights reserved 2025 &copy; CHATMANIA
			</h1>
		</div>
	);
};
